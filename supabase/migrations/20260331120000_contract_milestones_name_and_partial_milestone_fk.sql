...
do $$
begin
  if to_regclass('public.partial_account_line_items') is not null then
    ...
    raise notice 'Skipping partial account milestone FK migration: table public.partial_account_line_items does not exist';
  end if;
end
$$;
