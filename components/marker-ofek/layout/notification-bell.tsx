    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          className={cn(
            "absolute top-[calc(100%+6px)] z-[60] w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-xl border border-slate-200 bg-card shadow-xl ring-1 ring-slate-900/[0.04]",
  ...
  return (
    <div className={cn("relative", className)} ref={rootRef}>
      <Button
        ...
        variant="ghost"
        size="icon-sm"
        className="relative size-9 rounded-lg text-slate-600 hover:bg-slate-100 hover:text-foreground"
      ...
      <NotificationDropdownPanel open={open} align="end">
        <div className="border-b border-slate-100 px-3 py-2.5">
          <p className="text-sm font-semibold text-foreground">מרכז התראות</p>
            ...
            <li key={n.id}>
              <button
                ...
                className={cn(
                  ...
                  n.isRead
                    ? "bg-card hover:bg-background/80"
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    n.isRead ? "text-slate-600" : "font-medium text-foreground"
                  )}
                >
                  {n.message}
                </span>
