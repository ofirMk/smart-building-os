        ...
        >
          ...
          <div className="mb-3 border-b border-border/40 pb-2">
            <button
              ...
              onClick={() => {
                setCommandPaletteOpen(false)
                router.push("/marker-ofek/invoices/new")
              }}
              className={cn(
                "flex w-full items-center gap-2 rounded-lg px-2 py-2 text-start text-sm transition-colors",
                "hover:bg-slate-900/5 focus-visible:bg-slate-900/5 focus-visible:outline-none"
              )}
            >
              <FileText className="size-4 shrink-0 text-slate-600" aria-hidden />
              <span>מחולל חשבוניות — חשבונית מס חדשה</span>
            </button>
          </div>
