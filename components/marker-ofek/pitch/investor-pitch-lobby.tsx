...
function buildTiles(projectId: string): LobbyTile[] {
  return [
  {
    ...
    title: "חמ״ל פרויקט חכם",
    subtitle: "שליטה תפעולית מלאה",
    description:
      "תמונת-מצב תקציבית מלאה, אבני דרך בזמן אמת, דיווחי ביצוע מהשטח, ועוזר בינה מלאכותית עם זיהוי קולי בעברית להוצאת הזמנות רכש בלחיצה.",
    icon: <HardHat className="size-7" />,
    accent: "from-emerald-500/30 via-emerald-500/10 to-cyan-500/20",
    highlight: "₪10M תקציב מנוהל · ₪84K חיסכון חכם · 41% התקדמות",
    span: "wide",
  },
  {
    href: "/marker-ofek/finance",
    eyebrow: "💰 מרכז פיקוד פיננסי",
    title: "מרכז בקרה כספים",
    subtitle: "התאמה אוטונומית בזמן אמת",
    description:
      "התאמת חשבוניות אוטונומית מול הזמנות רכש, זיהוי מיידי של חריגות מחיר, תמונת תזרים מזומנים חיה, וזרימת חיסכון מצטברת.",
    icon: <Wallet className="size-7" />,
    accent: "from-amber-500/25 via-orange-500/10 to-rose-500/20",
    highlight: "92% התאמה אוטונומית · ₪216K חיסכון מצטבר",
  },
  {
    href: "/marker-ofek/projects/gantt",
    eyebrow: "📊 לוח תכנון וביצוע",
    title: "תכנון וקבלני משנה",
    subtitle: "גאנט חי וסנכרון מהשטח",
    description:
      "סטטוס משימות חי מהשטח, סינכרון אפליקציית מנהלי עבודה, ופריסת קבלני משנה פעילים לפי מקצוע ואזור עבודה.",
  ...
  },
  {
    ...
    title: "חבילות ותמחור",
    subtitle: "שלוש שכבות עם ROI מוכח",
    description:
      "מודל עסקי ברור: גישת שטח לכל פרויקט, מערכת ניהול מלאה להנהלה, ומנוע קרדיטים לשימושי בינה מלאכותית לפי דרישה.",
    icon: <Rocket className="size-7" />,
    accent: "from-fuchsia-500/30 via-violet-500/15 to-indigo-500/20",
    highlight: "$70/פרויקט · ₪2,500/מנוי · שימוש חכם לפי צריכה",
    span: "tall",
  },
  {
    href: "/marker-ofek/contracts-engine",
    eyebrow: "📜 חוזים ותשלומים",
    title: "מנוע חוזים וחשבונות קבלן (Smart Billing)",
    subtitle: "ניהול מחזור חיים פיננסי קצה-לקצה",
    description:
      "ניהול מחזור החיים הפיננסי קצה-לקצה: ניהול חכם של חוזי מזמין וקבלני משנה, אוטומציה מוחלטת של מפל תשלומים וקיזוזים (Waterfall), ניהול עכבונות ושליטה מלאה בתקציב בזמן אמת.",
    icon: <FileSignature className="size-7" />,
    accent: "from-emerald-500/25 via-teal-500/10 to-cyan-500/20",
    highlight: "אוטומציית קיזוזים · מערכת מפל כספים · הגנה מתקציב חורג",
  },
  ]
}
