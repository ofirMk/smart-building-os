  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetContent
        ...
        className={cn(
          "z-[60] w-[min(20rem,100vw)] border-0 bg-sidebar p-0 text-sidebar-foreground shadow-2xl [&>button]:hidden",
      ...
      >
        ...
        <motion.div
          className="flex h-full max-h-[100dvh] w-full flex-col overflow-hidden"
