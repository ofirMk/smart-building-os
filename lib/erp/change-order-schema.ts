...
const changeOrderBaseSchema = z.object({
...
export const ChangeOrderSchema = changeOrderBaseSchema.superRefine((value, ctx) => {
    if (
...
export const ChangeOrderPatchSchema = changeOrderBaseSchema
  .partial()
