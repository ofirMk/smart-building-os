...
export const MARKER_OFEK_PILLARS: MarkerOfekPillar[] = [
  ...
  },
  {
    ...
    navTitle: "רכש",
    cardTitle: "רכש",
    tagline: "מרכז רכש אחוד — טיוטה, הנפקה וקבלה מול נתוני מאסטר.",
    ...
    quickActions: [
      { title: "מרכז רכש אחוד", href: "/marker-ofek/procurement" },
      { title: "נתוני מאסטר", href: "/marker-ofek/master-data" },
