...
export default function ProcurementSuppliersMasterPage() {
  ...
  return (
    <div dir="rtl" className="mx-auto flex w-full max-w-7xl flex-col gap-6 pb-12">
      ...
      <div className="grid gap-4 lg:grid-cols-[300px_minmax(0,1fr)]">
        <Card className="border-border/70 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Parent: רשימת כל הספקים</CardDescription>
          </CardHeader>
        ...
        <Card className="border-border/70 shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg">Supplier Detail</CardTitle>
            <CardDescription>Child: פרטי קשר + רשימת פריטים ומחירי מו״מ אחרונים</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            {!selectedSupplier ? (
              ...
              <>
                <div className="grid gap-3 rounded-lg border border-border/60 bg-muted/20 p-3 sm:grid-cols-3">
                ...
                <section className="rounded-lg border border-border/60 bg-muted/10 p-3">
                  <p className="mb-2 text-xs font-semibold tracking-wide text-muted-foreground">
                    GRANDCHILD · פירוט פריט נבחר
                  </p>
                  {!selectedItem ? (
                    <p className="text-sm text-muted-foreground">
                      בחרו פריט מהרשימה העליונה להצגת שכבת Grandchild.
                    </p>
                  ) : (
                    <div className="grid gap-3 rounded-lg border border-border/60 bg-background p-3 sm:grid-cols-2">
                      <p className="text-sm">
      ...
      <div className="inline-flex items-center gap-2 rounded-md border border-border/60 bg-muted/20 px-3 py-2 text-xs text-muted-foreground">
        ...
        ניווט מהיר: שימוש במקלדת + בחירת ספק מיד מציגה Child מפורט.
      </div>
    </div>
  )
}
