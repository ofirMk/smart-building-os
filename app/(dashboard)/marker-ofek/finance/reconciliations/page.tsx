...
export default async function ReconciliationPage() {
  ...
  return (
    <div
      className="min-h-[calc(100vh-3rem)] bg-gradient-to-br from-slate-100/95 via-white to-violet-50/30 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900"
      dir="rtl"
    >
