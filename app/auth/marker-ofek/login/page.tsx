...
function LoginFallback() {
  return (
    <div className="mx-auto w-full max-w-md animate-pulse space-y-6 rounded-2xl border border-slate-100 bg-white p-8">
...
export default async function MarkerOfekLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-16">
      <div className="mx-auto max-w-lg rounded-2xl border border-slate-100 bg-white p-8 shadow-sm sm:p-10">
